                    ...
                    {({loading, error, data}: { loading: boolean, error?: ApolloError, data: any }) => {
                        ...
                        return (
                            <div className={styles.pageResult}>
                                ...
                                <span className={styles.resultHeader} style={{fontWeight: "normal"}}>ОСНОВЫ ПРОТИВОДЕЙСТВИЯ ТЕРРОРИЗМУ И</span>
                                <span className={styles.resultHeader} style={{fontWeight: "normal"}}>ЭКСТРИМИЗМУ В РОССИЙСКОЙ ФЕДЕРАЦИИ</span>
