...
class IntegratedSecurityBasicsTest extends React.Component<ITestPageProps, {
    value: any,
    i: number,
    arrAnswer: any[],
    arrLength: number,
...
const WrappedIntegratedSecurityBasicsTest = Form.create({ name: 'test-page' })(IntegratedSecurityBasicsTest);
export default WrappedIntegratedSecurityBasicsTest;
