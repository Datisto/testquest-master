...
class AntiTerrorTest extends React.Component<ITestPageProps, {
    value: any,
    i: number,
    arrAnswer: any[],
    arrLength: number,
...
const WrappedAntiTerrorTest = Form.create({ name: 'test-page' })(AntiTerrorTest);
export default WrappedAntiTerrorTest;
