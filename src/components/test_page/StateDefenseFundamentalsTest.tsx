...
class StateDefenseFundamentalsTest extends React.Component<ITestPageProps, {
    value: any,
    i: number,
    arrAnswer: any[],
    arrLength: number,
...
const WrappedStateDefenseFundamentalsTest = Form.create({ name: 'test-page' })(StateDefenseFundamentalsTest);
export default WrappedStateDefenseFundamentalsTest;
